    ...
    <div className="relative">
      <div className="mx-auto max-w-xl lg:max-w-7xl">
        <div className="mx-auto mb-14 max-w-2xl text-center">
          <span className="mb-4 inline-block rounded-full bg-gray-200 px-3 py-1 text-xs font-semibold text-black">
            OUR BLOG
          </span>
        ...
        <div className="my-18 -mx-4 flex flex-wrap px-4">
          <div className="mb-12 w-full px-4 lg:mb-0 lg:w-1/2">
            <a className="group block w-full" href="#">
              ...
              Join us on a journey through the fragrant realms of rose gardens, where petals dance in the gentle breeze and hues of pink, red, and white paint a picturesque landscape. From historic rose gardens to modern floral paradises, let's embark on a sensory adventure that celebrates the elegance and romance of the beloved rose.</p>
              </a>
            </div>
              <div className="w-full px-4 lg:w-1/2">
                <a className="group mb-8 md:flex" href="#">
                  ...
                  <div className="my-4 pt-2 md:ml-6 md:mt-0">
                    ...
                    Navigating the Balance Between Ambition and Well-being
                    </h4>
                  </div>
                  </a>
                  <a className="group mb-8 md:flex" href="#">
                  ...
                  <a className="group mb-8 md:flex" href="#">
                    ...
                    <span className="mb-2 block text-gray-500">Jul 20, 2022</span>
                    <h4 className="text-xl font-semibold text-gray-900">
                    Unlocking the Mysteries of Numbers and Patterns
                    </h4>
                  </div>
                  </a>
                </div>
              ...
              <div className="mt-14 text-center">
                <a href="/cards" 
                  className="rounded-full border border-black px-3 py-2 text-sm font-semibold text-black shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                >
                View All Blogs
          </a>
        </div>
